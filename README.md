...
##### x86_64 images
- `S3elasticsearch7` [Dockerfile](docker-image/v1.14/debian-s3elasticsearch7/Dockerfile)
  - `docker pull fluent/fluentd-kubernetes-daemonset:v1.14.6-debian-s3elasticsearch7-14.6-1.0`
